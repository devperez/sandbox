    ...
    <div class="w-4/12 p-6 rounded-lg">
        <form class="text-center pt-5" action="{{route('login') }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input class="border-2 bg-gray-200 w-full p-4 rounded-lg" type="email" id="email" name="email"
                    placeholder="Your email" value="{{old('email') }}">
            </div>
            <div class="mb-4">
                <label class="sr-only" for="password">Your password :</label>
                <input class="border-2 bg-gray-200 w-full p-4 rounded-lg" type="password" id="password" name="password"
